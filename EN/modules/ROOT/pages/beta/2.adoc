...
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/14[1、Ivorysql frame design]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/15[2、GUC Framework]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/16[3、Case conversion]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/17[4、Dual-mode design]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/18[5、Compatible with oracle like]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/19[6、Compatible with oracle anonymous block]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/20[7、Compatible with Oracle functions and stored procedures]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/21[8、Built-in data types and built-in functions]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/22[9、Added Oracle compatibility mode ports and IP]
