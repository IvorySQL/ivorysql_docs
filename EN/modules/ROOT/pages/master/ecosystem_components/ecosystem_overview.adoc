...
| *31* | xref:master/ecosystem_components/dbeaver.adoc[DBeaver] | 26.2.0 | Graphical database navigation, SQL editing, data editing, and execution plans | Database development and administration
|====
