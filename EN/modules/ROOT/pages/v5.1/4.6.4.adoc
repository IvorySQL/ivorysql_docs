...
```
[highgo@manager-node1 ~]$ podman pull ivorysql/IvorySQL 5.1-ubi8
✔ docker.io/ivorysql/IvorySQL 5.1-ubi8
Trying to pull docker.io/ivorysql/IvorySQL 5.1-ubi8...
...
```
$ podman run --name ivorysql -p 5434:5432 -e IVORYSQL_PASSWORD=123456 -d ivorysql/IvorySQL 5.1-ubi8
```
...
CONTAINER ID            IMAGE                       COMMAND          CREATED          STATUS          PORTS                                 NAMES
368dee58d5ef  docker.io/ivorysql/IvorySQL 5.1-ubi8  postgres    20 seconds ago  Up 20 seconds  0.0.0.0:5434->5432/tcp, 1521/tcp, 5866/tcp  ivorysql
