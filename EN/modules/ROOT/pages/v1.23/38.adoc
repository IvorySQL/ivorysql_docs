...
[TIP]
The source installation environment is Ubuntu 24.04 (x86_64). IvorySQL 1.22 and above is already installed in the environment, with the installation path at /usr/local/ivorysql/ivorysql-1
