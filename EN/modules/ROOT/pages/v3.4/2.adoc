...
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/14[1. Ivorysql frame design]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/15[2. GUC Framework]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/16[3. Case conversion]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/17[4. Dual-mode design]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/18[5. Compatible with Oracle like]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/19[6. Compatible with Oracle anonymous block]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/20[7. Compatible with Oracle functions and stored procedures]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/21[8. Built-in data types and built-in functions]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/22[9. Added Oracle compatibility mode ports and IP]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/26[10. XML Function]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.4/v3.4/27[11. Compatible with Oracle sequence]
