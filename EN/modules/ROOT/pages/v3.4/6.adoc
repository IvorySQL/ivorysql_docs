...
This chapter will provide detailed instructions on the installation, execution, and uninstallation processes for each method. For a quicker access to IvorySQL, please refer to xref:v3.4/3.adoc#quick-installation[Quick installation].
...
=== Uninstallation for dnf installation
