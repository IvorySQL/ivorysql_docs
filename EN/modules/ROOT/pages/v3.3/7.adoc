...
For quick database installation by yum, please refer to xref:v3.3/3.adoc#quick-installation[Quick installation]。

For more installation options, please refer to xref:v3.3/6.adoc#Installation[Installation]。
[NOTE]
