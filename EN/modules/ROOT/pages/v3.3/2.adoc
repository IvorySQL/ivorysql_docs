...
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/14[1. Ivorysql frame design]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/15[2. GUC Framework]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/16[3. Case conversion]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/17[4. Dual-mode design]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/18[5. Compatible with Oracle like]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/19[6. Compatible with Oracle anonymous block]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/20[7. Compatible with Oracle functions and stored procedures]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/21[8. Built-in data types and built-in functions]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/22[9. Added Oracle compatibility mode ports and IP]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.3/v3.3/26[10. XML Function]
