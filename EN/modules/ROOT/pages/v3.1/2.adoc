...
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/14[1、Ivorysql frame design]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/15[2、GUC Framework]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/16[3、Case conversion]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/17[4、Dual-mode design]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/18[5、Compatible with Oracle like]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/19[6、Compatible with Oracle anonymous block]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/20[7、Compatible with Oracle functions and stored procedures]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/21[8、Built-in data types and built-in functions]
* https://docs.ivorysql.org/cn/ivorysql-doc/v3.1/v3.1/22[9、Added Oracle compatibility mode ports and IP]
