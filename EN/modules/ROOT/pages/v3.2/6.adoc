...
This chapter will provide detailed instructions on the installation, execution, and uninstallation processes for each method. For a quicker access to IvorySQL, please refer to xref:v3.2/3.adoc#quick-installation[Quick installation].
...
$ sudo wget 
https://github.com/IvorySQL/IvorySQL/releases/download/IvorySQL_3.2/ivorysql3-3.2-1.rhel7.x86_64.rpm
...
$ sudo rpm -e ivorysql3-contrib-3.2-1.rhel7.x86_64
