...
For quick database installation by yum, please refer to xref:v3.2/3.adoc#quick-installation[Quick installation]。

For more installation options, please refer to xref:v3.2/6.adoc#Installation[Installation]。
[NOTE]
