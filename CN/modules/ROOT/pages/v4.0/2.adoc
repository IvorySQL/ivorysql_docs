...
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/14[ivorysql框架设计]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/15[GUC框架]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/16[大小写转换]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/17[双模式设计]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/18[兼容Oracle like]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/19[兼容Oracle匿名块]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/20[兼容Oracle函数与存储过程]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/21[内置数据类型与内置函数]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/22[新增Oracle兼容模式的端口与IP]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/26[XML函数]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/27[兼容Oracle sequence]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/28[包]
* https://docs.ivorysql.org/cn/ivorysql-doc/v4.0/v4.0/29[不可见列]