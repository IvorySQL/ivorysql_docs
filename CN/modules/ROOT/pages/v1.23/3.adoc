...
[source,]
----
[highgo@ivorysql ~]$ wget https://github.com/IvorySQL/IvorySQL/archive/refs/tags/IvorySQL_1.23.tar.gz
[highgo@ivorysql ~]$ tar -zxvf  IvorySQL_1.23.tar.gz
----
...
[source,]
----
[highgo@ivorysql ~]$ mv IvorySQL-IvorySQL_1.23 IvorySQL; ls
IvorySQL
...
wget https://github.com/IvorySQL/IvorySQL/releases/download/Ivory_REL_1_23/IvorySQL-1.23-*.x86_64.rpm


安装IvorySQL
[source,]
----
yum install IvorySQL-1.23-*.x86_64.rpm
----

初始化单机数据库
[source,]
----
/opt/IvorySQL-1.23/bin/initdb -D data/
----
