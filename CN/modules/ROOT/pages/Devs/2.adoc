...
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/14[ivorysql框架设计]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/15[GUC框架]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/16[大小写转换]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/17[双模式设计]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/18[兼容oracle like]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/19[兼容oracle匿名块]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/20[兼容oracle函数与存储过程]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/21[内置数据类型与内置函数]
* https://docs.ivorysql.org/cn/ivorysql-doc/devs/devs/22[新增oracle兼容模式的端口与ip]
